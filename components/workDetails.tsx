...
export function WorkDetails({
    ...
    if (displayType === 'VideoOnly') return <VideoOnly work={work} id={id} />
    if (displayType === 'FullImgTextLeft') return <FullImgTextLeft work={work} id={id} />
    if (displayType === 'FullImgTextRight') return <FullImgTextRight work={work} id={id} />
    if (displayType === 'FullImgTextTop') return <FullImgTextTop work={work} id={id} />
    if (displayType === 'MdImgTextLeft') return <MdImgTextLeft work={work} id={id} />
    if (displayType === 'MdImgTextRight') return <MdImgTextRight work={work} id={id} />
    if (displayType === 'MdImgTextTop') return <MdImgTextTop work={work} id={id} />
    if (displayType === 'BgImgTextLeft') return <BgImgTextLeft work={work} id={id} />
    if (displayType === 'BgImgTextRight') return <BgImgTextRight work={work} id={id} />
    if (displayType === 'BgImgTextBottom') return <BgImgTextBottom work={work} id={id} />
    else return <FullImgTextLeft work={work} id={id} />
}
...
function FullImgTextLeft({ work, id }: WorkTypeProps) {
    return (
...
function FullImgTextRight({ work, id }: WorkTypeProps) {
    return (
...
function FullImgTextTop({ work, id }: WorkTypeProps) {
    return (
...
function BgImgTextLeft({ work, id }: WorkTypeProps) {
    return (
        <div
            id={id}
            style={{ backgroundImage: `url(/assets/img/${work.media})` }}
...
function BgImgTextRight({ work, id }: WorkTypeProps) {
    return (
        <div
            id={id}
            style={{ backgroundImage: `url(/assets/img/${work.media})` }}
...
function BgImgTextBottom({ work, id }: WorkTypeProps) {
    return (
        <div
            id={id}
            style={{ backgroundImage: `url(/assets/img/${work.media})` }}
...
function MdImgTextLeft({ work, id }: WorkTypeProps) {
    return (
...
function MdImgTextRight({ work, id }: WorkTypeProps) {
    return (
...
function MdImgTextTop({ work, id }: WorkTypeProps) {
    return (
...
function VideoOnly({ work, id }: WorkTypeProps) {
    return (
