...
export default async function Home() {
  ...
  return (
    <>
      <header className="flex flex-col gap-5 p-8 pt-16 md:p-0 md:items-center md:h-screen md:justify-center md:bg-[url('/assets/img/home-header-img.png')] md:bg-cover md:bg-center text-primary-foreground md:text-secondary-foreground text-shadow-sm md:text-shadow">
      ...
      <main className='flex flex-col items-center justify-center py-16 md:py-32 gap-12 text-center text-primary-foreground'>
        {
          homeSections.map((section, index) => {
            return (
              <section key={section.title + index} className='flex flex-col gap-5 w-5/6 md:w-3/5 items-center'>
